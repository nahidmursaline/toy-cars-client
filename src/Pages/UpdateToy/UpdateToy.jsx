    ...
    return (
       ...
       <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className="form-control">
          ...
          <input type="text" defaultValue={description} name='description' placeholder="Detail Description" className="input input-bordered" />
        ...
        <div className="form-control mt-6">
          ...
          <input className="btn btn-error btn-block" type="submit" value="Update Toy" />
        </div>
       </form>
